            ...
            <a class="navbar-brand" href="index.php"><img alt="PQS" src="{{ asset('img/pqs.png') }}" width="50px" height="50px"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pelanggan.index') }}" style="color: white;">Beranda
                                <span class="sr-only">(current)</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pelanggan.produk') }}" style="color: white;">Produk</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pelanggan.pesanan') }}" style="color: white;">Pesanan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pelanggan.profile', Auth::user()->id) }}" style="color: white;">Profil</a>
                        </li>
                        @if (Route::has('login'))
                            @auth
                            <li class="nav-item">
